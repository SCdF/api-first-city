...
export const ResourceSchema = {
    ...
    properties: {
        id: {
            type: 'string',
            description: 'Unique ID for the patrol'
        },
        caseId: {
            type: 'string',
            description: 'Case ID'
...
export const PolicePatrolSchema = {
    type: 'object',
    properties: {
        id: {
            type: 'string',
...
export const PolicePatrolCreateSchema = {
    type: 'object',
    properties: {
        caseId: {
            type: 'string',
...
export const PolicePatrolUpdateSchema = {
    type: 'object',
    properties: {
        caseId: {
            type: 'string',
...
export const PolicePatrolListSchema = {
    type: 'object',
    properties: {
        items: {
            type: 'array',
