...
exports.initializeConfig = exports.configCache = void 0;
require("dotenv/config");
const config_factory_1 = require("@city-services/common/firebase/config-factory");
...
const configFactory = new config_factory_1.ConfigFactory(factoryOptions);
...
exports.configCache = ConfigCache.getInstance();
// Initialize the config (fetches remote values if available)
const initializeConfig = async () => {
    await exports.configCache.initialize();
};
exports.initializeConfig = initializeConfig;
// Export a simple config object for easy access to cached values
const config = {
    get port() {
        return exports.configCache.getConfig().port;
    },
    get environment() {
        return exports.configCache.getConfig().environment;
    },
    get version() {
        return exports.configCache.getConfig().version;
    },
    get serviceRegistry() {
        return exports.configCache.getConfig().serviceRegistry;
    },
    get iam() {
        return exports.configCache.getConfig().iam;
    },
    get serviceName() {
        return exports.configCache.getConfig().serviceName;
    },
    get db() {
        return exports.configCache.getConfig().db;
    },
    // Helper for dynamic values
    async getValue(key, defaultValue) {
        return exports.configCache.getValue(key, defaultValue);
    },
};
