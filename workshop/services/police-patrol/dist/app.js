...
async function createApp() {
    ...
    const resourceRepository = new police_repository_1.ResourceRepository();
    // Create services
    logger.info('Creating services...');
    const resourceService = new resource_service_1.PolicePatrolService(resourceRepository);
    // Create controllers
